...
class BattleDetailed extends StatefulWidget {
  final SubmissionModel submission;
  const BattleDetailed({super.key, required this.submission});

  @override
  State<BattleDetailed> createState() => _BattleDetailedState();
}

class _BattleDetailedState extends State<BattleDetailed> {
          ...
          children: [
            if (isImage)
              ImageBuilder(
                ...
                fit: BoxFit.cover,
                imageUrl: submission.story.mediaUrls,
  ...
  initStory() async {
    ...
    isImage = submission.story.mediaType == StoryMediaType.image;

    if (isImage) return;
    videoController = VideoPlayerController.network(submission.story.mediaUrls);
    setState(() {});
  }
}

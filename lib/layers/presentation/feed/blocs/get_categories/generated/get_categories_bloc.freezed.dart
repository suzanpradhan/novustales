...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<CategoryEntity> categories})
...
abstract class _Success implements GetCategoriesState {
  const factory _Success({required final List<CategoryEntity> categories}) =
      _$SuccessImpl;
...
class __$$FailedImplCopyWithImpl<$Res>
    extends _$GetCategoriesStateCopyWithImpl<$Res, _$FailedImpl>
...
class _$FailedImpl implements _Failed {
  ...
  @override
  String toString() {
    return 'GetCategoriesState.failed(message: $message)';
  }
...
abstract class _Failed implements GetCategoriesState {

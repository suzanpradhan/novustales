...
class _$AppEntityImpl implements _AppEntity {
  const _$AppEntityImpl({required this.isFirstTime});
  ...
  @override
  String toString() {
    return 'AppEntity(isFirstTime: $isFirstTime)';
  }
...
abstract class _AppEntity implements AppEntity {
  const factory _AppEntity({required final bool isFirstTime}) = _$AppEntityImpl;

...
/// @nodoc
@JsonSerializable(createToJson: false)
class _$UserStoryImpl extends _UserStory {
  ...
  @override
  String toString() {
    return 'UserStory(id: $id, userDetails: $userDetails, mediaUrl: $mediaUrl, category: $category, views: $views, title: $title, media: $media, mediaUrls: $mediaUrls, blobRef: $blobRef, latitude: $latitude, longitude: $longitude, name: $name, country: $country, state: $state, city: $city, county: $county, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _UserStory extends UserStory {
  const factory _UserStory(
      {required final int id,
      @JsonKey(name: 'user_details') required final StoryUserDetail userDetails,
      ...
      @JsonKey(name: 'updated_at')
      required final DateTime updatedAt}) = _$UserStoryImpl;
  const _UserStory._() : super._();
